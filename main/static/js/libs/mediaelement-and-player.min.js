...
mejs.version = "2.22.0", mejs.meIndex = 0, mejs.plugins = {
        ...
        init: function() {
            var e, t, i, n, s, o, a = this,
                r = document,
                l = mejs.PluginDetector.nav,
                u = mejs.PluginDetector.ua.toLowerCase(),
                d = ["source", "track", "audio", "video"];
            a.isiPad = null !== u.match(/ipad/i), a.isiPhone = null !== u.match(/iphone/i), a.isiOS = a.isiPhone || a.isiPad, a.isAndroid = null !== u.match(/android/i), a.isBustedAndroid = null !== u.match(/android 2\.[12]/), a.isBustedNativeHTTPS = "https:" === location.protocol && (null !== u.match(/android [12]\./) || null !== u.match(/macintosh.* version.* safari/)), a.isIE = -1 != l.appName.toLowerCase().indexOf("microsoft") || null !== l.appName.toLowerCase().match(/trident/gi), a.isChrome = null !== u.match(/chrome/gi), a.isChromium = null !== u.match(/chromium/gi), a.isFirefox = null !== u.match(/firefox/gi), a.isWebkit = null !== u.match(/webkit/gi), a.isGecko = null !== u.match(/gecko/gi) && !a.isWebkit && !a.isIE, a.isOpera = null !== u.match(/opera/gi), a.hasTouch = "ontouchstart" in window, a.svgAsImg = !!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1");
            for (e = 0; e < d.length; e++) t = document.createElement(d[e]);
            a.supportsMediaTag = void 0 !== t.canPlayType || a.isBustedAndroid;
            try {
            ...
            a.supportsPointerEvents = (n = document.createElement("x"), s = document.documentElement, o = window.getComputedStyle, "pointerEvents" in n.style && (n.style.pointerEvents = "auto", n.style.pointerEvents = "x", s.appendChild(n), i = o && "auto" === o(n, "").pointerEvents, s.removeChild(n), !!i)), a.hasFirefoxPluginMovingProblem = !1, a.hasiOSFullScreen = void 0 !== t.webkitEnterFullscreen, a.hasNativeFullscreen = void 0 !== t.requestFullscreen, a.hasWebkitNativeFullScreen = void 0 !== t.webkitRequestFullScreen, a.hasMozNativeFullScreen = void 0 !== t.mozRequestFullScreen, a.hasMsNativeFullScreen = void 0 !== t.msRequestFullscreen, a.hasTrueNativeFullScreen = a.hasWebkitNativeFullScreen || a.hasMozNativeFullScreen || a.hasMsNativeFullScreen, a.nativeFullScreenEnabled = a.hasTrueNativeFullScreen, a.hasMozNativeFullScreen ? a.nativeFullScreenEnabled = document.mozFullScreenEnabled : a.hasMsNativeFullScreen && (a.nativeFullScreenEnabled = document.msFullscreenEnabled), a.isChrome && (a.hasiOSFullScreen = !1), a.hasTrueNativeFullScreen && (a.fullScreenEventName = "", a.hasWebkitNativeFullScreen ? a.fullScreenEventName = "webkitfullscreenchange" : a.hasMozNativeFullScreen ? a.fullScreenEventName = "mozfullscreenchange" : a.hasMsNativeFullScreen && (a.fullScreenEventName = "MSFullscreenChange"), a.isFullScreen = function() {
                return a.hasMozNativeFullScreen ? r.mozFullScreen : a.hasWebkitNativeFullScreen ? r.webkitIsFullScreen : a.hasMsNativeFullScreen ? null !== r.msFullscreenElement : void 0
            }, a.requestFullScreen = function(e) {
                a.hasWebkitNativeFullScreen ? e.webkitRequestFullScreen() : a.hasMozNativeFullScreen ? e.mozRequestFullScreen() : a.hasMsNativeFullScreen && e.msRequestFullscreen()
            ...
            }), a.hasiOSFullScreen && u.match(/mac os x 10_5/i) && (a.hasNativeFullScreen = !1, a.hasiOSFullScreen = !1)
        }
    ...
    function(e, t, i) {
        ...
        "undefined" != typeof mejsL10n && (n.locale.language = mejsL10n.language), n.methods.checkPlain = function(e) {
            ...
            for (t in e = String(e), n) n.hasOwnProperty(t) && (i = new RegExp(t, "g"), e = e.replace(i, n[t]));
            return e
    ...
    function(e) {
        mejs.MepDefaults = {
                ...
                meReady: function(t, i) {
                    ...
                    if (!o.created) {
                        if (o.created = !0, o.media = t, o.domNode = i, !(a.isAndroid && o.options.AndroidUseNativeControls || a.isiPad && o.options.iPadUseNativeControls || a.isiPhone && o.options.iPhoneUseNativeControls)) {
                            for (n in o.buildposter(o, o.controls, o.layers, o.media), o.buildkeyboard(o, o.controls, o.layers, o.media), o.buildoverlays(o, o.controls, o.layers, o.media), o.findTracks(), o.options.features)
                ...
                setDimensions: function(e, t) {
                    this.container.width(e).height(t), this.layers.children(".mejs-layer").width(e).height(t)
                },
                ...
                buildposter: function(t, i, n, s) {
                    var o = e('<div class="mejs-poster mejs-layer"></div>').appendTo(n),
                        a = t.$media.attr("poster");
                    "" !== t.options.poster && (a = t.options.poster), a ? this.setPoster(a) : o.hide(), s.addEventListener("play", function() {
                        o.hide()
                ...
                remove: function() {
                    var e, t, i = this;
                    for (e in i.container.prev(".mejs-offscreen").remove(), i.options.features)
                        if (i["clean" + (t = i.options.features[e])]) try {
                            i["clean" + t](i)
                        } catch (e) {}
            ...
            function() {
                ...
                function i(i, n) {
                    ...
                    return e.each((i || "").split(" "), function(e, i) {
                        var o = i + "." + n;
                        0 === o.indexOf(".") ? (s.d.push(o), s.w.push(o)) : s[t.test(i) ? "w" : "d"].push(o)
                    }), s.d = s.d.join(" "), s.w = s.w.join(" "), s
                }
                mejs.MediaElementPlayer.prototype.globalBind = function(t, n, s) {
                    var o = this,
                        a = o.node ? o.node.ownerDocument : document;
                    (t = i(t, o.id)).d && e(a).bind(t.d, n, s), t.w && e(window).bind(t.w, n, s)
                }, mejs.MediaElementPlayer.prototype.globalUnbind = function(t, n) {
                    var s = this,
                        o = s.node ? s.node.ownerDocument : document;
                    (t = i(t, s.id)).d && e(o).unbind(t.d, n), t.w && e(window).unbind(t.w, n)
                }
    ...
    function(e) {
        e.extend(mejs.MepDefaults, {
            ...
            buildplaypause: function(t, i, n, s) {
                var o = this.options,
                    a = e('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="' + this.id + '" title="' + o.playText + '" aria-label="' + o.playText + '"></button></div>').appendTo(i).click(function(e) {
                        return e.preventDefault(), s.paused ? s.play() : s.pause(), !1
                    }),
                    r = a.find("button");

                function l(e) {
                    "play" === e ? (a.removeClass("mejs-play").addClass("mejs-pause"), r.attr({
                        title: o.pauseText,
                        "aria-label": o.pauseText
                    })) : (a.removeClass("mejs-pause").addClass("mejs-play"), r.attr({
                        title: o.playText,
                        "aria-label": o.playText
                    }))
                }
                l("pse"), s.addEventListener("play", function() {
                    l("play")
                }, !1), s.addEventListener("playing", function() {
                    l("play")
                }, !1), s.addEventListener("pause", function() {
        ...
        e.extend(mejs.MepDefaults, {
            ...
            buildprogress: function(t, i, n, s) {
                ...
                m.bind("focus", function(e) {
                    ...
                    return o = o < 0 ? 0 : o >= n ? n : Math.floor(o), f = new Date, v || s.pause(), o < s.duration && !v && setTimeout(y, 1100), s.setCurrentTime(o), e.preventDefault(), e.stopPropagation(), !1
                    ...
                    !1, h || (o.globalUnbind(".dur"), d.hide())
                }), s.addEventListener("progress", function(e) {
                    t.setProgressRail(e), t.setCurrentRail(e)
                }, !1), s.addEventListener("timeupdate", function(e) {
                    var i, n, o, a;
                    t.setProgressRail(e), t.setCurrentRail(e), i = s.currentTime, n = mejs.i18n.t("Time Slider"), o = mejs.Utility.secondsToTimeCode(i, t.options), a = s.duration, m.attr({
                        "aria-label": n,
                        "aria-valuemin": 0,
                        "aria-valuemax": a,
                        "aria-valuenow": i,
            ...
            buildvolume: function(t, i, n, s) {
                if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                    ...
                    l.bind("mouseover", function() {
                        ...
                        var t;
                        h || (s.muted ? (m(0), r.removeClass("mejs-mute").addClass("mejs-unmute")) : (m(s.volume), r.removeClass("mejs-unmute").addClass("mejs-mute"))), t = Math.floor(100 * s.volume), l.attr({
                ...
                if (!t.isPluginClickThroughCreated) {
                    ...
                    fullscreenBtn.on("mouseover", function() {
                        if (!t.isFullScreen) {
                            ...
                            for (i in media.positionFullscreenButton(e.left - n.left, e.top - n.top, !1), t.fullscreenBtn.css("pointer-events", "none"), t.controls.css("pointer-events", "none"), t.media.addEventListener("click", t.clickToPlayPauseCallback), a) a[i].show();
                            l(), s = !0
                        }
        ...
        e.extend(mejs.MepDefaults, {
            ...
            loadTrack: function(t) {
                ...
                e.ajax({
                    ...
                    dataType: "text",
                    success: function(e) {
                        "string" == typeof e && /<tt\s+xml/gi.exec(e) ? n.entries = mejs.TrackFormatParser.dfxp.parse(e) : n.entries = mejs.TrackFormatParser.webvtt.parse(e), n.isLoaded = !0, i.enableTrackButton(n.srclang, n.label), i.loadNextTrack(), "chapters" == n.kind && i.media.addEventListener("play", function(e) {
            ...
            removeTrackButton: function(e) {
                this.captionsButton.find("input[value=" + e + "]").closest("li").remove(), this.adjustLanguageBox()
            },
